...
- after you run the options on client it will create a sqlite db named database in the folder which can be browsed
- [example client transcript](#transcript) 
...
## example client transcript<a name="transcript"></a>
